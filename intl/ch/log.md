...
**今天的进展：** 阅读了早读文章，学习了前端性能优化13-1。

**思考：** 前端早读主要介绍了篡改NPM窃取比特币事件的始末，警醒我们在引用其他开源包时，不要直接拿来用，最好先了解一下。前端优化主要介绍了调试工具的使用，主要是Chrome的Performance。
...
**今天的进展：** 阅读了早读文章，学习了前端性能优化13-2。

**思考：** 前端早读主要介绍了前端程序员为何要关注设计，主要还是可以提升用户体验。前端优化主要介绍了LightHouse和性能API。
...
**今天的进展：** 阅读了早读文章，学习antd源码入口index。

**思考：** 将前几天的早读文章补充看了一下，然后学习了antd的index文件及tag组件。（中断了20天，主要是前端优化看完了就没去找新的东西看。）
...
**今天的进展：** 阅读了早读文章，继续看了Tag源码。

**思考：** 早读主要看了React conf内容，主要介绍了当前面临的三个问题，以及解决问题的新功能hook。
...
**思考：** 早读主要学习了eslint的原理，完成Tag源码的阅读。